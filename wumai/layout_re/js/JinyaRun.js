...
(function(){
    ...
    imgUrl = "http://tieba.baidu.com/tb/zt/weixingame/wumai/img/avatar.png";
    lineLink = "http://tieba.baidu.com/tb/zt/weixingame/wumai/index.html";
    descContent = '万能贴吧防霾指数';
    shareTitle = '百度贴吧-防霾指数小测试';
    appid = '';
    ...
    JinyaRun.prototype={
		...
		adjustPsotion:function(){
				...
				main.css({height:pureH});
				/*main.find(".result_title").css({top:0.21*pureH}); //20%
		...
		initData:function(){
			...
			self.canTouch = true;
			this.resultArray= [];
			this.resultArray.push({title:"35.2",tip:'已经打败了全国<span class="red">77.5%</span>的人坚持活下来',des:'中国特色社会主义体魄就是这么「吹」出来的，人类防霾基因就靠你延续了！',forum:'<a href="http://tieba.baidu.com/f?kw=牛逼吧">牛逼</a><a  href="http://tieba.baidu.com/f?kw=生物" >生物吧</a><a  href="http://tieba.baidu.com/f?kw=宇宙">宇宙吧</a>'});
			this.resultArray.push({title:"59.6",tip:'已经打败了全国<span class="red">50.2%</span>的人坚持活下来',des:'一直都从「良」，练练就升「优」，防霾还得心肺好，出门记得戴口罩！',forum:'<a href="http://tieba.baidu.com/f?kw=健身">健身吧</a><a href="http://tieba.baidu.com/f?kw=跑步">跑步吧</a><a href="http://tieba.baidu.com/f?kw=口罩">口罩吧</a>'});
			this.resultArray.push({title:"78.3",tip:'已经打败了全国<span class="red">13.8%</span>的人坚持活下来',des:'「差一点儿及格」说的就是你，抗冻靠属性，防霾靠装备，钱还够吗？',forum:'<a href="http://tieba.baidu.com/f?kw=雾霾">雾霾吧</a><a href="http://tieba.baidu.com/f?kw=绿植">绿植吧</a><a href="http://tieba.baidu.com/f?kw=兼职">兼职吧</a>'});
			this.resultArray.push({title:"91.5",tip:'已经打败了全国<span class="red">0.9%</span>的人坚持活下来',des:'间接性蓝天的环境已经不适合你了，学好外语攒好钱以后再作打算吧！',forum:'<a href="http://tieba.baidu.com/f?kw=移民">移民吧</a><a href="http://tieba.baidu.com/f?kw=旅行">旅行吧</a><a href="http://tieba.baidu.com/f?kw=空气">空气吧  </a>'});
		},
        initIndex:function(){
            var start=[0,0];
            var direction = 0;
        ...
        showResult:function(i){
				...
				main.find(".title_tip").html(res["tip"]);
