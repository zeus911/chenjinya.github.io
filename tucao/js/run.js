(function(){
    ...
    imgUrl = "http://www.einino.net/tucao/img/caologo.png";
    lineLink = "http://www.einino.net/tucao/index.html";
    descContent = '吐槽贴吧熊';
    shareTitle = '吐槽贴吧熊';
    appid = '';
    var Game = function(){
    ...
    Game.prototype={
        ...
        imageArray:[
			...
			"img/logos/wenku.png",
			"img/logos/yuedu.png",
			"img/logos/hao123.png",
			"img/logos/aiwan.png",
			"img/logos/shipin.png",
            "img/logos/yinyue.png",
            "img/logos/lecai.png",
			"img/logos/zhidao.png"
        ...
        bindEvent:function(){
            ...
            this.stage.on("touchstart",function(e){
                ...
                if(self.runIntoCheck(t.pageX,t.pageY) && self.startFlag){
                   if(self.touchable ) self.runIn ++;
		...
		var self= this;
            ...
            image.onload = function() {
                ...
                callback(self.resizeImage(image));
            }
        },
        drawBackgournd:function(){
            ...
            context.drawImage(this.imageStack[this.imageStackIndex],this.windowWidth/2 -this.imageStack[this.imageStackIndex].width/2,this.windowHeight /2 -this.imageStack[this.imageStackIndex].height/2,this.imageStack[this.imageStackIndex].width,this.imageStack[this.imageStackIndex].height);
        ...
        timeCounterGo:function(){
            ...
            var html = ' <div><p>吐槽'+this.runIn+'了个贴吧熊</p>'+'</div>'+
                ...
                '<p><a class="contact" href="http://tieba.baidu.com/f?kw=陈金亚&fr=washbear" >about</a></div>';
            if (this.eraseCount == 0){
                html = ' <div><p>真遗憾</p><p>你没有吐槽技能</p></div>'+
                    '<div class="btn_wrapper"> <div id="shareGame" class="btn">右上角分享</div>'+
                    '<div id="restartGame" class="btn">重新开始</div><p ><a class="contact" href="http://tieba.baidu.com?fr=washbear" >百度贴吧，为兴趣而生</a></p>' +
                    '<p><a class="contact" href="http://tieba.baidu.com/f?kw=陈金亚&fr=washbear" >about</a></p></div>';
            }
